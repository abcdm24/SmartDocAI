...
namespace SmartDocAI.Infrastructure.Services
{
    ...
    public class DocumentAIService : IDocumentAIService
    {
        ...
        {
            return await Task.FromResult("Summary generated by AI");
            //Running correct code - Start
        ...
        {
            return await Task.FromResult("Response generated by AI");
            //Running correct code - Start
