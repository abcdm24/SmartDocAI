...
namespace SmartDocAI.Infrastructure.Services
{
    public class DocumentService : IDocumentService
    {
        ...
        public async Task<IDocument> UploadDocumentAsync(IDocument document)
        {
        ...
        public async Task<IDocument> UploadDocumentAsync(IFormFile file, string userName)
        {
            //var document = new Document
            //{
            //    Id = Guid.NewGuid(),
        ...
        {
            _logger.LogInformation("Get document by ID from repository started: {Id}", id);
        ...
        public async Task<Guid> CreateDocumentAsync(IDocument document)
        {
        ...
        public async Task<bool> UpdateDocumentAsync(Guid id, IDocument document)
        {
